...
def registry_complete_command(args):
    ...
    print(f"📊 Total: {stats['total_datasets']} datasets ({stats['success_rate']}% success)")
...
def main():
    ...
    complete_parser = subparsers.add_parser('complete', help='Generate complete registry')
    complete_parser.add_argument('--input', required=True, help='Input registry JSON file')
