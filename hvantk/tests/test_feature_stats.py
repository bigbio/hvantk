...
def test_feature_coverage_stats():
    rows = [
        {
            ...
            "median_expression": 5.0,
            "constraint_score": 0.8,
            "AF": 0.01,
            "feature_completeness": 0.9,
        },
        {
            "combined_deleteriousness": None,
            "median_expression": 2.0,
    ...
    ht = hl.Table.parallelize(
        [
            hl.struct(
                combined_deleteriousness=safe_float(
                    row.get("combined_deleteriousness")
                ),
