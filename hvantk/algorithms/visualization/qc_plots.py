...
For a combined HTML report assembling these plots, see
``hvantk.algorithms.visualization.qc_report.generate_qc_report``.
...
Example:
    ...
    >>> fig = plot_sample_qc_overview(qc_results.get_sample_metrics_df())
    >>> plt.show()
"""
