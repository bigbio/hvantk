...
class APIEndpointGenerator:
    ...
    def generate_status_api(self, registry: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "success_rate": round(
                    (successful / total_datasets * 100) if total_datasets > 0 else 0, 1
                ),
            },
            "status_breakdown": dict(status_counts),
            "last_update": max(
                (data["timestamp"] for data in registry.values()), default=None
            ),
        }
        ...
        return {
            "statistics": {
                ...
                "success_rates": {
                    ...
                    "expression_atlas": self.calculate_success_rate(
                        registry, "expression_atlas"
                    ),
                },
            },
    ...
    def calculate_success_rate(
        self, registry: Dict[str, Any], dataset_type: str
    ) -> float:
        """Calculate success rate for a specific dataset type."""
        type_datasets = [
            data for data in registry.values() if data["dataset_type"] == dataset_type
        ]
