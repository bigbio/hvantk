"""Local conftest for the Expression Atlas plugin tests.
...
of ``hvantk/tests/`` -- without this shim, marked tests in this folder would
not receive the shared session fixture.
