"""Snapshot round-trip test for the Ensembl gene builder.
...
Regenerate after an intentional change:
    pytest hvantk/skills/ensembl_gene/tests/test_builder_snapshot.py --regenerate-snapshots
"""
...
FIXTURE = "hvantk/tests/testdata/raw/ensembl/ensembl_gene_biomart.tsv.bgz"
SNAPSHOT_DIR = Path("hvantk/skills/ensembl_gene/tests/snapshots")
...
@pytest.mark.hail
def test_ensembl_gene_snapshot_round_trip(hail_session, tmp_path, regenerate_snapshots):
    """Build Ensembl gene from fixture; assert schema and sample-row stability."""
    import hail as hl
    from hvantk.skills.ensembl_gene.builder import build_ensembl_gene_genes

    builder = phase_b_snapshot_adapter(build_ensembl_gene_genes, "ensembl-gene:genes")
