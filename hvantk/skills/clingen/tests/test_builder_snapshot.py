"""Snapshot round-trip test for the ClinGen builder.
...
Regenerate after an intentional change:
    pytest hvantk/skills/clingen/tests/test_builder_snapshot.py --regenerate-snapshots
"""
...
SNAPSHOT_DIR = Path("hvantk/skills/clingen/tests/snapshots")
...
SAMPLE_KEYS = [
    {"hgnc_id": "1100", "mondo_id": "0005144"},
    {"hgnc_id": "1100", "mondo_id": "0013683"},
    {"hgnc_id": "1101", "mondo_id": "0005145"},
    {"hgnc_id": "11998", "mondo_id": "0007903"},
    {"hgnc_id": "1748", "mondo_id": "0008594"},
    {"hgnc_id": "583", "mondo_id": "0021056"},
]


@pytest.mark.hail
def test_clingen_snapshot_round_trip(hail_session, tmp_path, regenerate_snapshots):
    """Build ClinGen from fixture; assert schema and sample-row stability."""
    import hail as hl
    from hvantk.skills.clingen.builder import build_clingen_gene_disease

    builder = phase_b_snapshot_adapter(build_clingen_gene_disease, "clingen:gene-disease")
